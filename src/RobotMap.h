...
#define DRIVE_SPEED_CONTROLLER_FL_CHANNEL 7
#define DRIVE_SPEED_CONTROLLER_FR_CHANNEL 5
#define DRIVE_SPEED_CONTROLLER_BL_CHANNEL 3
#define DRIVE_SPEED_CONTROLLER_BR_CHANNEL 2

#define RAMP_SPEED_CONTROLLER_INTAKE_LEFT_CHANNEL 1
#define RAMP_SPEED_CONTROLLER_INTAKE_RIGHT_CHANNEL 4

#define CLIMB_SPEED_CONTROLLER_EXTEND_CHANNEL 6
#define CLIMB_SPEED_CONTROLLER_RETRACT_CHANNEL 8

#define RAMP_SPEED_CONTROLLER_UPPER_LEFT_CHANNEL 1
#define RAMP_SPEED_CONTROLLER_UPPER_RIGHT_CHANNEL 0
#define RAMP_SPEED_CONTROLLER_MIDDLE_LEFT_CHANNEL 3
#define RAMP_SPEED_CONTROLLER_MIDDLE_RIGHT_CHANNEL 2
#define RAMP_SPEED_CONTROLLER_LOWER_LEFT_CHANNEL 5
